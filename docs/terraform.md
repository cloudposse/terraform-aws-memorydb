...
| <a name="input_additional_users"></a> [additional\_users](#input\_additional\_users) | List of additional users to create for the MemoryDB cluster | `list(string)` | `[]` | no |
...
| <a name="input_create_admin_user"></a> [create\_admin\_user](#input\_create\_admin\_user) | Indicates whether to create an admin user for the MemoryDB cluster | `bool` | `true` | no |
...
| <a name="input_parameter_group_name"></a> [parameter\_group\_name](#input\_parameter\_group\_name) | The name of the parameter group to associate with this cluster. | `string` | `null` | no |
